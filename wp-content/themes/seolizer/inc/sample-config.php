<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
			...
			array(
                'id'        => 'seolizer-number-href',
                'type'      => 'text',
                'title'     => __( 'Телефон (в ссылке)', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
			...
			array(
                'id'        => 'seolizer-number-pretty',
                'type'      => 'text',
                'title'     => __( 'Телефон (внешний вид)', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( '', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
			...
			array(
                'id'       => 'seolizer-email',
                'type'     => 'text',
                'title'    => __( 'Контактный адрес почты', 'redux-framework-demo' ),
                'subtitle' => __( '', 'redux-framework-demo' ),
                'desc'     => __( '', 'redux-framework-demo' ),
                'validate' => 'email',
			...
			array(
                'id'        => 'seolizer-header-title',
                'type'      => 'textarea',
                'title'     => __( 'Заголовок в шапке', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( '', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
	...
	Redux::setSection( $opt_name, array(
        'title'            => __( ' Кнопки', 'redux-framework-demo' ),
        'id'               => 'seolizer-header-buttons',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
        'fields'           => array(
			array(
                'id'        => 'seolizer-button-call',
                'type'      => 'text',
                'title'     => __( 'Кнопка 1', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( '', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
			...
			array(
                'id'        => 'seolizer-button-consult',
                'type'      => 'text',
                'title'     => __( 'Кнопка 2', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( '', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
			...
			array(
                'id'        => 'seolizer-button-order',
                'type'      => 'text',
                'title'     => __( 'Кнопка 3', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( '', 'redux-framework-demo' ),
                'default'   => '',
                'text_hint' => array(
