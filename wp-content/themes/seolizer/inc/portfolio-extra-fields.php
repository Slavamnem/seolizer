...
function my_extra_fields() {
	...
	add_meta_box( 'extra_fields', 'Дополнительные поля', 'extra_fields_box_func2', 'portolio', 'normal', 'high'  );
}
...
function extra_fields_box_func2( $portfolio ){
	?>
	<p><label><input type="text" name="extra[title]" value="<?php echo get_metadata('portfolio', $portfolio->ID, 'title', 1); ?>" style="width:50%" /> ? заголовок страницы (title)</label></p>

	<p>Описание статьи (description):
		<textarea type="text" name="extra[description]" style="width:100%;height:50px;"><?php echo get_metadata('portfolio', $portfolio->ID, 'description', 1); ?></textarea>
	</p>
